                    ...
                    <div class="collapse navbar-collapse" id="navbarSupportedContent">
                        <div class="navigation d-flex">
                            <ul class="navbar-nav nav-left">
                                <li class="nav-item">
                                    <a class="nav-link" href="#" aria-haspopup="true" aria-expanded="false">PT. jaringan Inklusi Keuangan</a>
                                </li>
                                <li class="nav-item">
                            ...
                            <ul class="navbar-nav nav-right ml-auto">
                                ...
                                <li class="nav-item">
                                    <a class="nav-link" href="#" aria-haspopup="true" aria-expanded="false">asd</a>
                                </li>
                                <li class="nav-item">
